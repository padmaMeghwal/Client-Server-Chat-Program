...
public class server_frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        frnds = new javax.swing.JTextArea();
        ...
        frnds.setColumns(20);
        frnds.setRows(5);
        jScrollPane2.setViewportView(frnds);
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(usr)
                                        .addGap(45, 45, 45)
                                        .addComponent(usr_field, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(40, 40, 40)
                                .addComponent(btn)))
    ...
    private void b_startActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_startActionPerformed
        ...
        File fout = new File("C:/wrk/in.txt");;
        FileOutputStream fos;
        String line;
        try {
            fos = new FileOutputStream(fout, true);
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(fos));
            File file = new File("C:/wrk/in.txt");
    ...
    private void btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActionPerformed
        String username = usr_field.getText();
        String pwd1 = pwd_field.getText();
        ...
        try {
            if (start == true) {
                ...
                boolean flag = false;
                String str1 = usr_field.getText().trim();
                String[] tmp;
                ...
                fileReader.close();
                if (flag == false) {
                    bw.write(username.trim() + "#" + pwd1);
                    bw.newLine();
                    JOptionPane.showMessageDialog(null, "New User Added!!!!!");
                    frnds.append("\n");
                    frnds.append(username);
                  
                }
                bw.close();
            } else {
                JOptionPane.showMessageDialog(null, "First start the Server");
            }
        } /*bw.write(usrname.trim() + "#" + pwd1);
        bw.newLine();
         */ // JOptionPane.showMessageDialog(null, "New User Added!!!!!");
        // bw.close();
        //} 
    ...
    private javax.swing.JTextArea frnds;
